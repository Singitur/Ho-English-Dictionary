...
chã > to be suspended in the air (used in prayers of the sun, moon and stars) 

cháṕ > to open the mouth; to yawn (esp. in expressions such as a chabińtana. I am yawning")
*chaṕ > having one's mouth open (used in reviling or joking)
*cháṕ-chaṕ > to repeatedly open the mouth, e.g. as a chicken or a crow does on an excessively hot day
*cháṕ-enḍaḱ > to be utterly open mouthed (e.g. listening to something with amazement)
*cháṕ-hapan > to be still with one's mouth open (ref. form)
*cháṕ-hućoḱ > to come with mouth wide open 
...
cháka > to put a stick, with sayti, straw or grass tied around the top, into a field (esp. where kansari or some vegetable is being grown) to indicate that people should not enter there nor let cattle enter; to put the same into a shallow pond (dakud) to indicate that people should not fish there; used in prayers of the tiril daru and soso pats planted in the fields on the occasion of batauli 

chakã́ > same as chakãṛa, q.v. 
...
*chakat́-aagu > to trick someone into getting down deceiving,
*chakat́-jalua > deceitful
*chakat́-labaḱ > deceiving, deceitful
*chakat́-makat́ > false, lying (a jingle on chakad) 
...
chaki > a grinding stone (more proper Ho would be rid diri) 
...
chakur > poetic parallel of honor, to roam (not used inde- pendently) 

chal > of a bird, squirrel, monkey, man, to jump or swing from one branch of a tree to another; of a silkworm, to move from branch to branch; of a man, to jump from stone to stone, e.g. in a muddy place; as verbal affix to pass something on through an intermediary chal-ban to continuously jump from branch to branch (as in chal, refl. form)
...
*chanaṕ hora > walking backwards (same as usa hora); coming up from behind one (same as doyapa hora)
*chanaṕ-maaṅ > some later, some earlier, e.g. of people arriving at different times, of people finishing their work; some behind, some in front (for this ayer-chanab is more commonly used)
...
*chanalao gusiya > a manager, director 

chanchaṛat́ > a bamboo contraption, rather broad at one end and narrow toward the other end, used to steer fish into a kumbad where they are trapped (also called janjid) 
...
*chanḍaṅ-parom > to step over chandara-bunduru see chandra- bundru 
...
chandi bonga > a malign spirit of a juguni type (also called hicha- chandi bonga) (at least in some prayers considered female, e.g. pauÈ™i, mã pãuri chandiko, chandi kõwariko. Hindus refer to the goddess Durga as chandi) 
...
changuṛiya > a drum-beat and dance of the ba feast (other beats of the Bah feast are gena and gadua or jadur)
...
chapaṭa > flat (same as chapanṭa) the 
...
chapo > of the mouth, to be shrunken in (by its formation rather than by broken teeth or loss of teeth, in which case chaimun or chaipun would be used) 

chaprãsi > see chaparasi 
...
*chapu-eset́ > to block or check by feeling with the hands (e.g. large fish trying to jump out through the opening in a muchu; also used of someone blocking his sight by putting his hands over his eyes) chapu-nam to seek or find by feeling e.g. in the dark or by a blind man 

chapui-chapui > sometimes said playfully at the end of a verse by one playing the banam or a flute (also likewise baṭin-baṭin is sometimes said) 
...
charkaniya lijaḱ > a sari with coloured stripes/bands see 
...
charon > a kind of spell (see 

bãra) charpa > poetic parallel of gandu (see chalpa); a plank used in a bullock cart, on which plank the driver can sit; of bread/cakes - made into a rather thick, flat shape 

charpatu > a herb with broad leaves and small tubers from which medicine is made, prob. Ruellia suffruticosa, Roxb., Acanthaceae, H.104/9/3 (cf. E.M. carpandu) 

char-sira > pass. form to have hydrocele (prob. from Hindi; in Ho the pass. of anduwa could also be used) 

chaṛu > to throw or fall into water, to put an ingredient (e.g. poison) into a liquid (e.g. rice beer) charu-gue; to kill by an action as given under charu 

chaṛu Oe > the Baya Weaver  bird 

chas, chaso > cultivation, to cultivate (also taso)
*chasi (tan) hÆ¡ > a cultivator 

chasoma > eye-glasses 

chata > porob an annual non-Ho feast, which Hos attend and at which they dance (e.g. in villages Aita and Balandia) 
...
chatakam > same as chamata, q.v.; used in prayers in the term tiril chatakam, q.v. 

chatani > same as chatari 

chaṭãri > a very large flat rock (implies something more extensive than seren) 

chatela > very weak and thin (used esp. of women, sometimes of animals) 
...
*chatom aḱ > a four leaf clover (with big leaves) growing on the edges of ponds or flooded ricefields. The leaves are edible. Marsilea quadrifolia, Linn., Marsileaceae, E.M., H. pp. 1271-2
*chatom-danan > to put in the shelter or shade of an umbrella
*chatom-dandaḱ > the handle of an umbrella
chatom kata > the rib of an umbrella (also called chatom panjar)
*chatom-lijaḱ > the cloth of an umbrella chatom panjari the rib of an umbrella
chatom owaḱ > a house with the inner part of the house raised higher and having a separate roof than the outer part
...
chauriya > of a fighting cock, to lose the spirit for fighting (after many fights) 

chauriya > a small worm which comes out of a silk-worm cocoon and is eaten by villagers 

chawoḱ > a tribe of people like the Birhors living in the jungle 

chaw-chaw > the confused noise of a multitude; repented scolding in an angry voice 

chawom > to dry up excessively e.g. rice grains spread out to dry (so that they crumble when touched) or paddy left too long on the stalk after ripening (see also rochod) 

chawor-mawor > the confused noise of many people conversing together 

chawta sigit́ > a type of sigid diri (q.v.) which can be cut out in long, broad, thick, whitish slabs 

chay(leka) > to feel a burning sensation from extreme heat of the sun
...
*chelaṅken > having the size and shape of a chelaṅ

chele > a to speak indistinctly as a small child does 
...
chep-chep > e a bird which makes a chep-chep sound, found more around March and April 
...
chéra > beautiful
*chéra-méra > a jingle on chera, beautiful 
...
chere chipili > a collective noun for flying beings such as birds and insects 
...
chere-bete (tan) > to made the noise made when wood of the tiril tree burns(with verbs lo, sari,etc.); to chat making a noise like that of tiril wood burning (with verb jagar) 
...
*chetan-ji > hypocrisy; chetan-jite kaji speak in a hypocritical or insincere manner
...
*chete-chete > the cry of the chari bird 

cheṭe-chete > of rice-beer when after straining it is left sitting for some time, to become somewhat flat and tasteless, (the word could refer to a slight bubbling sound made in that condition) 
...
chi > an exclamation of disgust often repeated many times, also chid 

-chi > affixed to participial forms to indicate an action preceding another action (te is more commonly used for this and -ed is also sometimes used) 
...
chidu > a caterpiller; the larvae of insects; a small crawling insect; a maggot; of a maggot, etc. to infest e.g. a wound in cattle (chiduwakan could mean 'infested by maggots' or 'still in the larva stage')
...
cheleka (te) > how? to do something in what manner? to treat someone in what manner? (note the term chelekaktredo, an impersonal construction (Les. 26) cheleka+ke+i +redo 'if something has in some manner or other affected him', almost like the expression in English, 'whatever it is that has gotten into him'
*cheleka bano cheleka > in some way or other 

chelekan > what kind of? 

Chilip > e another name for the Hon Oe, q.v.
...
*chimin cheleka > very much, e.g. chimin cheleka rasaki:ya, 'how happy he was', 'he was very happy'
*chiminre > after, when (introducing a dependent clause, e.g. when it will be ready) 

chiminaṅ > how much? how many? chiminanleka a few 

chiminoḱ (ge) > to what extent (much the same as chimin joka) 

chimir-chitan > active, smart, up and doing 

chimita > at what time? 

chimitaṅ > at what time? 

Chimitikir Ut́ > a kind of edible mushroom having a hot (haaht́) taste
chimpíḱ > how much? how many? 
...
chírt́ > very thin, narrow, e.g. of an embankment between two fields
*chírt́-chírt́ > along narrow embankments (where grass is available for cattle to graze) 

chira > a fault which requires damages to be paid for harm done; to be endebted to pay damages for harm done
*chira kata baba > a variety of paddy seeds usually sown in prote or occasionally in Goṛa Ote. This ripens early 

chira-birae > same as chiri-biri, q.v. 
...
chiri-biri/chiri-biri > a slight smarting sensation in one's skin such as is sometimes experienced after scrubbing and applying soap on a very cold day.(chtri-btri is the more common forn) (chtra-birae is also used for this) 

chirit́-birit́ > the sound made by a squirrel (tt) 
...
chirpi-chiluṅ > a kind of ear ornament, golden in colour but of an inexpensive material, worn by young girls; of a bird, to balance itself in the air, e.g. when catching hold of a caterpillar from a branch mins 

chiru > dumbua kind of weed or grass which often grows in clusters and is often found on embankments, prob. Imperata arundinaceae, Cyrill., Gramineae, B.139/25; H.139/55/1 

Chiruṅ > dumbu a term sometimes used for the grass more commonly called sirun dumbu, q.v. 

chiṭa > to accuse falsely or unjustly 

chitaḱ > of e.g. the floor of a house, on which wet mud (Hasa) has been spread by hand (jalom), to crack 

chitaw > a time of the year between Goma and Indi and probably corresponding to the Hindu chhat feast 

Chiti Biṅ > the common krait (more often called bara chitÃ­ biń) 

Chiti Kula > a tiger or leopard said to eat cattle and have small stripes and varied colours (perhaps the word originally referred to the cheeta) (also called sona chiti kuls) 

chiṭi > a letter, a (drawn) lot 

chiti-biti > to squander, scatter 
...
*choeć-haṭiṅ > to divide or share by breaking off a portion or portions 
...
chonda > if a spirit, to enter someone e.g. in order to cause harm; of a person, to take the side of one party when two people are arguing 
...
chopot́-inun > to enjoy oneself by sucking the juice from something held to the mouth 
...
chopora lungam > very weak cocoons (choporako is also used for this 

chora > verbal affix used with tiki, to boil (e.g. rice) simply in water 

chora > dumbu a variety of tall grass from which circular hats and brooms are made, also sudugan, q.v.
*chora jonoḱ dumbu > same as chora dumbu 

chora haku > a rather common fish, 4-5 inches long, found in ponds, rivers and ricefields 
...
chuluć > to take hold of the lips, esp. the lower one, and pinch so that the central part juts out 

chuluć-chuluć (tan) > the cry of the hon Oe or of the dedem (sparrow)
...
chundula > to stretch the legs forward (and in some contexts somewhat upward, e.g. the legs of a chicken dying on its back) chundula-darom to oppose (prevent) by outstretching the legs forward (used of chickens dying with their outstretched legs facing the North preventing good rains and causing famine)
...
*chungi-mungia > jingle on chungi with the same meaning 
...
chunur > the crown of the head, where the hair grows in a spiral pattern, of men or animals; good forune; to receive out of good fortune (using a te form, e.g. chunurtema - You received out of good fortune') 

chupat́ > a bush (also churpad, compare pudat́, a bush which has developed fresh offshoots after pruning or trimming) 
...
churuḱ-buruḱ (tan) > the action of nibbling quickly (with verb ger, etc.) 

churu-churu > to heap up something so that it progressively becomes smaller toward the top 
...
Chuṭit́ Siraḱ > a name given in some places to the Liad Siraḱ or Danḍet́ Siraḱ, the Grey Wagtail 
