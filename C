...
chachi: (चचिः) to split off a part (strip) of e.g. a bamboo pole or a log

chā-chū (चा’-चू) words used to encourage a baby to walk; baby talk for ’to walk’

chada:-chada: (चदः-चदः) to jump up and down with both feet together (used esp. of small birds) (Often used with -tan and verbs such as sen or nir, e.g. chada:-chada:- tane: nireya, ’He will run away hopping along’)(also dacha:-dacha:)

chaḍchom (चड्‌चोम) same as chaḍlom

chaḍlom (चड्‌लोम)- a tail; of the flower of the sarjom tree, to develop a long extension when the fruit is emerging
*chaḍlom ipil - a comet (also called jono: ipil)
*chaḍlom muți - the part of the body of an animal from which the tail protrudes

chador (चदोर)- a shawl; a large piece of e.g. asbestos

chaḍra (चडरा) bald

chadul (चदुल) to bounce up and down, e.g. a cart on a rough road

chae:-chui: (चएः-चुइः) the sound made by rats or mice when playing, eating, etc.; the sound of whipping

chāi: (चाइः) of paddy grains or of fruit seeds, to be sunken with the shell empty or almost empty (with no hope that it could give fruit)

chãi (चंइ) to stretch out tightly, to distend e.g. a rope, the skin of a running animal; to stretch out a web or a thread (as is sometimes done from one tree to another to drive out spirits); the web of a spider; a spread out thread
*chãi-biyur - to stretch around, (as under chãi)

chaila (चइला) oe - another name of the hon oe, the Greyheaded Flycatcher (also called chuila oe)

chaimuṅ (चइमुङ)- same as chaipuṅ,

chaipun (चइपुङ) one whose mouth is shrivelled and sunken because he has lost his teeth

chaka (चका) to test the taste of some liquid, esp. rice beer before buying or drinking
*chaka-leka same as chaka
*chaka-sala to select by tasting e.g. which of two varieties or rice-beer to buy

chaka (चका) a wheel

chaka (चका) hasa firm soil which has grass in it and is useful for building up the sides of broken embankments, etc.

chakā (चका’) - Chakradharpur

chāka (चा’का) to put a stick, with sayu, straw or grass tied around the top, into a field (esp. where kansari or some vegetable is being grown) to indicate that people should not enter there nor let cattle enter; to put the same into a shallow pond (ḍakuḍ) to indicate that people should not fish there; used in prayers of the tiril daru and soso patā planted in the fields on the occasion of batauli

chakā̃ (चकां’)-same as chakãṛa, q.v.

chaka-chaka (चका-चका) to squat down supporting oneself only on one’s feet (see also chuchungūr)

chakaḍ (चकड्‌) false, deceiving; a lie; to deceive; (in a compound root when chakaḍ is put first, it means to trick or deceive someone into doing the action given in the second root; however when chakaḍ is in the second place it means to pretend to do or to deceive others
